...
1. Speichere dein Bild als **`profile.jpg`** (genauer Dateiname, alles klein).
2. Lege es **direkt in diesen Ordner** (`public/images/profile.jpg`).
3. Browser-Tab neu laden – das Bild erscheint im Hero.

## Testen

Im Browser öffnen: <http://localhost:3000/images/profile.jpg>
