...
export const profile = {
  ...
  subtitle: {
    de: "BSc Informatik ZHAW · KI & Machine Learning",
...
export const experiences: Experience[] = [
  {
    role: {
      de: "Projektleiter / SPOC (80%) im Software Engineering",
    ...
    bullets: {
      de: [
        "Entwicklung und Anpassung von Java-Anwendungen (Spring Boot, REST-APIs) für Gerichtsmanagement-Software, die in Schweizer Gerichten eingesetzt wird",
        "Entwicklung einer kompletten Datenbankmigration (100+ Tabellen, MS SQL → PostgreSQL): Transformationslogik, Validierungspipelines und Rollback-Prozeduren",
        "Implementierung und Durchführung von Abnahmetests (UAT), Fehler-Tracking und Kundenfreigabe-Prozessen",
        "Planung und Durchführung von 3 produktiven Go-Lives inklusive vollständiger Datenmigration und Überwachung nach dem Deployment",
        "Administration von Linux- und Windows-Server-Umgebungen, Datenbankarbeit mit PostgreSQL und Oracle",
        "Anwendung agiler Methoden (Scrum/Kanban) zur Koordination von Engineering-, QA- und Kunden-Teams",
      ],
      en: [
  ...
  {
    role: {
      de: "Werkstudent – Prozessdesign & Digitalisierung",
...
export const projects: Project[] = [
  {
    ...
    location: "Zürich",
    description: {
      de: "KI-basierte Plattform zur Dokumentenanalyse für eine Anwaltskanzlei (300+ Anwälte) – RAG-basiertes Parsing, Chunking und Aufbereitung juristischer Dokumente mittels LLMs. Von 0 auf 1 in einem cross-funktionalen Team aufgebaut.",
    ...
    highlights: {
      de: [
        "Entwurf und Implementierung des REST-API-Backends und der RAG-Pipeline: Chunking-Strategie, Embedding-Auswahl und Retrieval-Optimierung für juristische Q&A",
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      de: "Datenschutzkonformes RAG-System für den juristischen Bereich (vollständig on-premise) mit hybrider Suche via Qdrant + PostgreSQL (RRF). Vollständige Umsetzung vom Forschungs-Prototyp bis zum demoreifen System in Zusammenarbeit mit LogObject AG.",
    ...
    highlights: {
      de: [
        "Definition eines Evaluations-Frameworks und einer Benchmark-Suite (N=742, XQuAD) zur Messung der Modellqualität",
        "Iterative Optimierung der Retrieval-Pipeline auf Basis quantitativer Resultate",
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      de: "Erweiterung von VersionRAG (Huwiler, Stockinger, Fürst – ZHAW): ein RAG-System, das Dokumentversionen aktiv erkennt, indexiert und bei der Antwortgenerierung einbezieht.",
    ...
    highlights: {
      de: [
        "Entwurf eines graphbasierten Versionierungs-Layers mit Neo4J und Vektorsuche",
        "LLM-gesteuerte Versionserkennung und Kontext-Einbindung während der Antwortgenerierung",
      ],
      en: [
...
export const achievements: Achievement[] = [
  {
    ...
    description: {
      de: "Entwicklung einer kompletten Datenbankmigration (100+ Tabellen, MS SQL → PostgreSQL) – produktiv eingesetzt in 3 Kundenumgebungen.",
  ...
  {
    title: {
      de: "Evaluations-Framework für KI-Retrieval",
      en: "AI Retrieval Evaluation Framework",
    },
    description: {
      de: "Entwicklung eines Evaluations-Frameworks für ein KI-Retrieval-System mit MRR@5: 0.96 und Recall@5: 0.99.",
      en: "Designed an evaluation framework for an AI retrieval system with MRR@5: 0.96 and Recall@5: 0.99.",
    },
  },
  {
    title: {
      de: "3 produktive Enterprise-Deployments",
      en: "3 Enterprise Production Deployments",
    },
    description: {
      de: "End-to-End-Auslieferung von 3 Enterprise-Deployments mit Datenmigration, Validierung und Überwachung nach dem Deployment – keine kritischen Vorfälle.",
